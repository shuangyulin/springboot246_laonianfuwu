<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="派送状态" prop="paisongzhuangtai">
          <el-select :disabled="ro.paisongzhuangtai" v-model="ruleForm.paisongzhuangtai" placeholder="请选择派送状态">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="派送状态" prop="paisongzhuangtai">
	      <el-input v-model="ruleForm.paisongzhuangtai"
                placeholder="派送状态" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="员工账号" prop="yuangongzhanghao">
          <el-input v-model="ruleForm.yuangongzhanghao" 
              placeholder="员工账号" clearable  :readonly="ro.yuangongzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="员工账号" prop="yuangongzhanghao">
              <el-input v-model="ruleForm.yuangongzhanghao" 
                placeholder="员工账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  created() {
	this.ruleForm.shijian = this.getCurDate()
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.lianxifangshi = true;
          ...
          if(o=='paisongzhuangtai'){
            this.ruleForm.paisongzhuangtai = obj[o];
	    this.ro.paisongzhuangtai = true;
            continue;
          }
          if(o=='shijian'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `renwuwancheng/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.renwuwanchengCrossAddOrUpdateFlag = false;
						 this.parent.search();
