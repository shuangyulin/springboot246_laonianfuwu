      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='yuangong'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.yuangongzhanghao" class="input" type="text" placeholder="员工账号">
			   </div>
			 </div> -->
			<el-form-item label="员工账号" class="input" v-if="tableName=='yuangong'">
			  <el-input v-model="ruleForm.yuangongzhanghao" autocomplete="off" placeholder="员工账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yuangong'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
